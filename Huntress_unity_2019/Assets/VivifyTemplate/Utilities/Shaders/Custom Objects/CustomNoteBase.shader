        ...
        */
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float shadow = pow(1-(saturate(dot(-worldToLocal(_WorldSpaceLightPos0-0.5), i.coord*2))), 2);
                return float4(Color * saturate(sampleReflectionProbe(i.coord)*100+0.25) * shadow, 0);
            }
            ENDCG
        }
        Pass
