Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/83226041e01c1834d9e4271a56b3ab52"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_DETAILTEX) || !defined(OPTIMIZER_ENABLED)
				half3 detailTexture = POI2D_SAMPLER_PAN_STOCHASTIC(_DetailTex, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DetailTexUV*/)], float4(5,5,0,0)), float4(0,0,0,0), (1.0 /*_DetailTexStochastic*/)).rgb * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_DetailTintThemeIndex*/));
				#else
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				for (uint glitterLayer = 0; glitterLayer < uint((1.0 /*_GlitterLayers*/)); glitterLayer++)
				{
					...
					half3 glitterColor = poiThemeColor(poiMods, float4(0.02028856,0.01298303,0.008023192,1).rgb, (0.0 /*_GlitterColorThemeIndex*/));
					...
					glitterMask *= float4(0.02028856,0.01298303,0.008023192,1).a;
