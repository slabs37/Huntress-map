Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/0f5d3b5ee876c1a4a955f1e1be28b414"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, pow(abs(poiFragData.baseColor), (0.75 /*_MainGamma*/)), hueShiftAlpha.a);
				...
				poiFragData.baseColor = saturate(lerp(poiFragData.baseColor, poiFragData.baseColor * ((-0.08 /*_MainBrightness*/) + 1), hueShiftAlpha.g));
				#endif
